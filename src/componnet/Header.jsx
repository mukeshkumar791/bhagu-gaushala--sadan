...
const Header = () => {
 ...
 <div className='gaushale-make-informations'>
          ...
          <p>बाके बिहारी गौशाला एक ऐसा स्थान है जो गायों के प्रति प्रेम और देखभाल के लिए विशेष रूप से डिज़ाइन किया गया है। इसका निर्माण एक दूरदर्शी व्यक्ति की कृपा से हुआ है, जिनका उद्देश्य बेसहारा, घायल या दुर्घटनाग्रस्त गायों और मवेशियों को भोजन, आश्रय और चिकित्सा सहायता प्रदान करना है। सुनील निमाणा जी के प्रयासों का ही परिणाम है कि गोकुलधाम गौ सेवा महातीर्थ हरियाणा का सबसे बड़ा गौ उपचार अस्पताल खोल पाया है। गोपाष्टमी के पावन पर्व पर गोकुलधाम की देखरेख में गंगा गौ-संवर्धन केंद्र की स्थापना की गई है। इस पहल के मुख्य उद्देश्य के अनुसार, प्रत्येक गाँव को गौग्राम बनाना है।
गोकुलधाम ने निम्नलिखित सेवाएँ प्रदान की हैं और अभी भी प्रदान कर रहा है:</p>
<p>सीज़ेरियन ऑपरेशन</p>
<p>रुनोटॉमी ऑपरेशन</p>
<p>1000 से अधिक गायों को दवा दी गई।</p>
<p>सूचना मिलते ही, गायों की सुरक्षा और बचाव के लिए एम्बुलेंस दौड़ पड़ती है।
बड़े ऑपरेशन चाहे कितना भी समय या पैसा क्यों न लगे, किए जाते हैं।</p>
 ...
 {/* <section className='section-padding'> 
  <div className='container'>
    <div className='cow-tretment-information'>
<div className='tretment-card'> 
<div className='ps'>
  <img className='' src={untilet4} alt="" />
  <span className='btn-oring'>cow babies</span>
</div>
</div>
       ...
       <section className='section-padding'>  
        <div className='container'>
          <div className='interdution-tittle d-flex flex-column '>
            ...
            <p>श्री बांके बिहारी गौ सेवा सदन
          ...
          <div className='information-crads'>
            <div className='information-card-items'>
              ...
              <div className='px-3 text-center '>
                ...
                <p >एम्बुलेन्स सेवा के लिए दूरभाष 9214926790 पर सूचना दें </p>
              </div>
            </div>
            <div className='information-card-items'>
              <div className='text-center font'>
          ...
          <div className='tuladan-section'>
            ...
            <div className='tuladan-tittle'>
              ...
              <p>हमारे धर्म शास्त्रों में तुलादान का बहुत ही बड़ा महत्व है। मनुष्य अपने वजन के बराबर गौखाद्य सामग्री तोलकर गोमाता को अर्पित करता है, तो उसका बहुत ही पुण्य लाभ मिलता है। तुलादान करने से अनिष्ठ ग्रहों की शांति होती है और घर परिवार में सुख शान्ति समृद्धि बनी रहती है।</p>
...
<p>1.विश्व स्तरीय गौ चिकित्सालय के लावारिस पीड़ाग्रस्त गोवंश को लाने हेतु पशु एम्बुलेन्स की व्यवस्था की गई है। 
  ...
  4.गौशालाओं से एक बीमार गोवंश लेकर आते है तो उनको भी एक बीमार के बदले में एक स्वस्थ गोवंश दिया जाता है।
   ...
   7.गो चिकित्सालय में स्वस्थ गोवंश एवं दूध देने वाली गायों को नहीं रखा जाता और ना ही लिया जाता है।
    ...
    किराये में कुछ राशि कम रहती है, तो उस राशि का भुगतान कर दिया जायेगा।</p>
    </div>
        </div>
      </section>
<section className='section-padding'>
  <div className='container'>
<h2 className='font text-center'>सब वेद पुराण भी, गऊ महिमा गाते है। <br />
